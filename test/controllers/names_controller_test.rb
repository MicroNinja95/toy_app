...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { user_email: @name.user_email, user_name: @name.user_name } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { user_email: @name.user_email, user_name: @name.user_name } }
